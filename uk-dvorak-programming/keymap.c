...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_EXLM,        KC_TRANSPARENT, KC_LBRACKET,    KC_RBRACKET,    KC_ASTR,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_LABK,        KC_RABK,        UK_MINS,        UK_PLUS,        KC_F12,
    TO(0),          UK_COLN,        KC_DLR,         KC_LCBR,        KC_RCBR,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_LPRN,        KC_RPRN,        UK_UNDS,        UK_EQL,         UK_DQUO,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    LCTL(KC_PGUP),  LCTL(KC_PGDOWN),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
